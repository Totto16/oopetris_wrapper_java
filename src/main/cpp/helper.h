...
#define JAVA_OOPETRIS_CLASS_NAME_IMPL(X) "com" X "github" X "oopetris"

#define JAVA_OOPETRIS_CLASS_NAME JAVA_OOPETRIS_CLASS_NAME_IMPL(JAVA_CLASS_NAME_SEPERATOR)

#define JAVA_OOPETRIS_CLASS_NAME_WITH_DOTS JAVA_OOPETRIS_CLASS_NAME_IMPL(".")
